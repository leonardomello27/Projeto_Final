...
## Generated on : Thu Aug 03 20:54:35 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Adaptive_sf.mexw64
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Adaptive_sf.mexw64
...
DEFINES_STANDARD = -DMODEL=Adaptive -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMDL_REF_SIM_TGT=1
...
SRCS = $(START_DIR)/Adaptive_sfcn_rtw/Adaptive_sf.c $(START_DIR)/Adaptive_sfcn_rtw/Adaptive_sf_data.c $(START_DIR)/Adaptive_sfcn_rtw/rtGetInf.c $(START_DIR)/Adaptive_sfcn_rtw/rtGetNaN.c $(MATLAB_ROOT)/extern/version/c_mexapi_version.c
...
OBJS = Adaptive_sf.obj Adaptive_sf_data.obj rtGetInf.obj rtGetNaN.obj c_mexapi_version.obj
...
SYSTEM_LIBS =  -L"$(MATLAB_ROOT)/extern/lib/win64/mingw64" -llibut -llibfixedpoint -llibmx -llibmex
...
Adaptive_sf.obj : $(START_DIR)/Adaptive_sfcn_rtw/Adaptive_sf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Adaptive_sf_data.obj : $(START_DIR)/Adaptive_sfcn_rtw/Adaptive_sf_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.obj : $(START_DIR)/Adaptive_sfcn_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.obj : $(START_DIR)/Adaptive_sfcn_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"
